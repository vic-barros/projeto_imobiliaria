...
public class Apartamento extends Imovel {
	...
	public Apartamento(Endereco endereco, double area, StatusImovel status, double valor, int andar, int numeroApt,
			double iptu, double vlrCondominio) {
	...
	public String toString() {
		return super.toString() + " | Tipo: Apartamento: \nApt: " + numeroApt + "\nAndar: " + andar
				+ "\nCondomínio: R$ " + vlrCondominio + "IPTU R$ " + iptu;
	}
}
